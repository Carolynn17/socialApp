...
<div class="container" x-data="{ rightSide: false, leftSide: false }">
  ...
  <path d="M19 12H5M12 19l-7-7 7-7"/>
    ...
    <div class="logo">CODE NINJAS</div>
    ...
    <div class="main-container">
      <div class="profile">
        <div class="profile-avatar">
          <img src="caro.JPG" alt="" class="profile-img">
          <div class="profile-name">  Welcome Apio Caroline</div>
        </div>
          ...
          <div class="intro box">
            ...
            <div class="info">
              ...
              <div class="info-item">
                ...
                Player name <a href="#">Apio Caroline</a>
              </div>
            </div>
          </div>
          <div class="event box">
            <div class="event-wrapper">
              ...
              <div class="event-title">Campus Bazaar</div>
              <div class="event-subtitle">01st Jan, 2022 07:00AM</div>
            </div>
          </div>
          <div class="pages box">
            <div class="intro-title">
            ...
            <div class="user">
              <img src="caro.JPG" alt="" class="user-img">
              <div class="username">Kyakuwa</div>
            </div>
            <div class="user">
              <img src="caro.JPG" alt="" class="user-img">
        ...
        <div class="timeline-right">
          <div class="status box">
            ...
            <div class="status-main">
              <img src="caro.JPG" class="status-img">
              <textarea class="status-textarea" placeholder="Write something to Apio Caroline.."></textarea>
            </div>
          ...
          <div class="album box">
            <div class="status-main">
              ...
              <div class="album-detail">
                <div class="album-title"><strong>Apio Caroline</strong> create new <span>album</span></div>
  ...
  <div class="right-side" :class="{ 'active': rightSide }">
    <div class="account">
      ...
      <span class="account-user"> Apio Caroline
        <img src="caro.JPG" alt="" class="account-profile" alt="">
        <span>▼</span>
      </span>
    </div>
    <div class="side-wrapper stories">
      ...
      <div class="user">
        <img src="caro.JPG" alt="" class="user-img">
        <div class="username">Kyakuwa penninah
          <div class="album-date">12 hours ago</div>
        </div>
      </div>
      <div class="user">
        <img src="caro.JPG" alt="" class="user-img">
        <div class="username">Ayee Mirriam
          <div class="album-date">29 minutes ago</div>
        </div>
      </div>
      <div class="user">
        <img src="caro.JPG" alt="" class="user-img">
        <div class="username">Kansiime Kenneth
    ...
    <div class="side-wrapper contacts">
      ...
      <div class="user">
        <img src="caro.JPG" class="user-img">
        <div class="username">Kiiza Trevour
          <div class="user-status"></div>
        </div>
      </div>
      <div class="user">
        <img src="caro.JPG" class="user-img">
        <div class="username">Alayo hellen
          <div class="user-status offline"></div>
        </div>
      </div>
      <div class="user">
        <img src="caro.JPG" class="user-img">
        <div class="username">Carole
          <div class="user-status offline"></div>
        </div>
      </div>
      <div class="user">
        <img src="caro.JPG" class="user-img">
        <div class="username">Acen Imma
          <div class="user-status"></div>
        </div>
      </div>
      <div class="user">
        <img src="caro.JPG" class="user-img">
        <div class="username">Emolu john
          <div class="user-status"></div>
        </div>
      </div>
      <div class="user">
        <img src="caro.JPG" class="user-img">
        <div class="username">Atim petua
          <div class="user-status"></div>
        </div>
      </div>
      <div class="user">
        <img src="caro.JPG" class="user-img">
        <div class="username">Annet Among
          <div class="user-status"></div>
        </div>
      </div>
      <div class="user">
        <img src="caro.JPG" class="user-img">
        <div class="username">Amulen Jane rose
          <div class="user-status idle"></div>
        </div>
      </div>
      <div class="user">
        <img src="caro.JPG" class="user-img">
        <div class="username">Wangoic Abraham
          <div class="user-status"></div>
        </div>
      </div>
      <div class="user">
        <img src="caro.JPG" alt="" class="user-img">
        <div class="username">Acen lesley
          <div class="user-status idle"></div>
        </div>
      </div>
    </div>
